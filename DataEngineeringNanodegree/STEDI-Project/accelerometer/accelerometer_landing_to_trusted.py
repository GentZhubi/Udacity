...
SELECT acceloremeter_landing.*
FROM acceloremeter_landing
JOIN customer_trusted_tmp
ON acceloremeter_landing.user = customer_trusted_tmp.email

'''
SQLQuery_node1719616789375 = sparkSqlQuery(glueContext, query = SqlQuery2725, mapping = {"acceloremeter_landing":AccelerometerLanding_node1719616767569, "customer_landing":CustomerLanding_node1719616736301}, transformation_ctx = "SQLQuery_node1719616789375")
